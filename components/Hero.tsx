        ...
        <div className="flex justify-center relative my-20 z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                ...
                <TextGenerateEffect
                    ...
                    words="Innovating the Future, One Line of Code at a Time"
                    />

                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2l'>
                    Hi, I&apos;m Atyub, a Full Stack Developer blending creativity with technical expertise to build dynamic web and mobile applications.
                </p>
