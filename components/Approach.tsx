  ...
  return (
    <section className="w-full py-20">
        <h1 className="heading">
            Built With <span className="text-purple">Cutting-Edge</span> Technologies
        </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card 
            title="React + Next.js" 
            icon={<AceternityIcon order="Framework" />}
            description="Laid the groundwork for the portfolio by setting up React and Next.js. Ensured seamless integration of modern frameworks to enable server-side rendering and dynamic routing for better performance and scalability."
            >
            <CanvasRevealEffect
                animationSpeed={5.1}
        ...
        <Card 
            title="Typescript" 
            icon={<AceternityIcon order="Componenets"/>}
            description="Developed reusable and modular components using TypeScript. Focused on creating clean, maintainable, and type-safe code to enhance reliability and ensure scalability for future updates."
            >
            <CanvasRevealEffect
                animationSpeed={3}
        ...
        <Card 
            ...
            description="Implemented responsive and modern styling using TailwindCSS. Designed an intuitive and visually appealing user interface optimized for all devices, ensuring a seamless user experience."
            >
            <CanvasRevealEffect
                animationSpeed={3}
